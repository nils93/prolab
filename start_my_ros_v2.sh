...
gnome-terminal -- bash -c "source ~/turtle_ws/devel/setup.bash && roslaunch example_package start_v2.launch; exec bash"
sleep 5

# 4. Starte filter_node
echo "Starte filter_node..."
gnome-terminal -- bash -c "source ~/turtle_ws/devel/setup.bash && roslaunch filter_node_wlm start.launch; exec bash"
